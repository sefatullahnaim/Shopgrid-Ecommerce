                                        ...
                                        <div class="dropdown d-md-flex profile-1">
                                            <a href="#" data-bs-toggle="dropdown"
                                                ...
                                                <div class="text-center p-1 d-flex d-lg-none-max">
                                                    <h6 class="mb-0" id="profile-heading">Hi,
                                                        {{ auth()->user()->name }}<i
                    ...
                    <div class="main-sidemenu">
                        ...
                        <ul class="side-menu">
                            ...
                            <li class="slide">
                                ...
                                <ul class="slide-menu">
                                    <li><a href="{{ route('categories.create') }}" class="slide-item">Create
                                            Category</a></li>
                                    <li><a href="{{ route('categories.index') }}" class="slide-item">Manage
                                            Categories</a></li>
                                </ul>
                            </li>
                            <li class="slide">
                                ...
                                <ul class="slide-menu">
                                    <li><a href="{{ route('sub-categories.create') }}" class="slide-item">Create Sub
                                            Category</a></li>
                                    <li><a href="{{ route('sub-categories.index') }}" class="slide-item">Manage Sub
                                            Categories</a></li>
                                </ul>
                            </li>
                            <li class="slide">
                                <a class="side-menu__item" data-bs-toggle="slide" href="#">
                                    ...
                                    <span class="side-menu__label">Brand Module</span><i
                                        class="angle fa fa-angle-right"></i></a>
                                <ul class="slide-menu">
                                    <li><a href="{{ route('brands.create') }}" class="slide-item">Create Brand</a>
                                    </li>
                                    <li><a href="{{ route('brands.index') }}" class="slide-item">Manage Brands</a>
                                    </li>
                                </ul>
                            </li>
                            <li class="slide">
                                <a class="side-menu__item" data-bs-toggle="slide" href="#">
                                    ...
                                    <span class="side-menu__label">Unit Module</span><i
                                        class="angle fa fa-angle-right"></i></a>
                                <ul class="slide-menu">
                                    <li><a href="{{ route('units.create') }}" class="slide-item">Create Unit</a></li>
                            ...
                            <li class="slide">
                                <a class="side-menu__item" data-bs-toggle="slide" href="#">
                                    ...
                                    <span class="side-menu__label">Product Module</span><i
                                        class="angle fa fa-angle-right"></i></a>
                                <ul class="slide-menu">
                                    <li><a href="{{ route('products.create') }}" class="slide-item">Create
                                            Product</a></li>
                                    <li><a href="{{ route('products.index') }}" class="slide-item">Manage
                                            Products</a></li>
                                </ul>
                            </li>
                            <li class="slide">
                                <a class="side-menu__item" data-bs-toggle="slide" href="#">
                                    ...
                                    <span class="side-menu__label">Customer Module</span><i
                                        class="angle fa fa-angle-right"></i></a>
                                <ul class="slide-menu">
                                    <li><a href="maps1.html" class="slide-item">Manage Customers</a></li>
                                </ul>
                            </li>
                            <li class="slide">
                                <a class="side-menu__item" data-bs-toggle="slide" href="#">
                            ...
                            <li class="slide">
                                <a class="side-menu__item" data-bs-toggle="slide" href="#">
                                    ...
                                    <span class="side-menu__label">Courier Module</span><i
                                        class="angle fa fa-angle-right"></i></a>
                                <ul class="slide-menu">
                                    <li><a href="maps1.html" class="slide-item">Create Courier</a></li>
                                    <li><a href="maps1.html" class="slide-item">Manage Couriers</a></li>
                                </ul>
                            </li>
                            <li class="slide">
                                <a class="side-menu__item" data-bs-toggle="slide" href="#">
            ...
            <div class="container">
                <div class="row align-items-center flex-row-reverse">
                    <div class="col-md-12 col-sm-12 text-center">
                        Copyright © 2026 <a href="#">Sefatullah</a>. Designed with <span
                            class="fa fa-heart text-danger"></span> by <a href="#"> Sefatullah </a> All rights
                        reserved
                    </div>
                </div>
            </div>
