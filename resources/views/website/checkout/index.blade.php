                                                ...
                                                <div class="payment-option-wrapper">
                                                    <div class="single-payment-option">
                                                        ...
                                                        <label for="shipping-1">
                                                            <img src="{{ asset('/') }}assets/images/shipping/shipping-1.png"
                                                                alt="Sipping">
                                                    ...
                                                    <div class="single-payment-option">
                                                        ...
                                                        <label for="shipping-2">
                                                            <img src="{{ asset('/') }}assets/images/shipping/shipping-2.png"
                                                                alt="Sipping">
                                                            <p>Standerd Shipping</p>
                                                            <span class="price">$10.50</span>
                                                        </label>
                                                    ...
                                                    <div class="single-payment-option">
                                                        ...
                                                        <label for="shipping-3">
                                                            <img src="{{ asset('/') }}assets/images/shipping/shipping-3.png"
                                                                alt="Sipping">
                                                            <p>Standerd Shipping</p>
                                                            <span class="price">$10.50</span>
                                                        </label>
                                                    ...
                                                    <div class="single-payment-option">
                                                        ...
                                                        <label for="shipping-4">
                                                            <img src="{{ asset('/') }}assets/images/shipping/shipping-4.png"
                                                                alt="Sipping">
                                                            <p>Standerd Shipping</p>
                                                            <span class="price">$10.50</span>
                                                        </label>
