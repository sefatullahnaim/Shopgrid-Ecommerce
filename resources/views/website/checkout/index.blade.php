                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="single-checkbox checkbox-style-3">
                                                        <label class="me-3"> <input type="radio" name="payment_method" value="cash" checked/> Cash On Delivery </label>
                            ...
                            <div class="checkout-sidebar-price-table">
                                ...
                                <div class="sub-total-price">
                                    ...
                                    <div class="total-price">
                                        <p class="value pe-3">{{$cartProduct->name}} - ( {{$cartProduct->price}} * {{$cartProduct->qty}} ) : </p>
