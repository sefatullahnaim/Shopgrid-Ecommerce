            ...
            <div class="row">
                ...
                @foreach ($categories as $category)
                    <div class="col-lg-4 col-md-6 col-12 d-flex">
                        ...
                        <div class="single-category w-100 d-flex flex-column">
                            <h3 class="heading">{{ $category->name }}</h3>

                            <ul>
                                @forelse ($category->subCategories->take(4) as $sub)
                                    <li>
                                        <a href="#">{{ $sub->name }}</a>
                                    </li>
                                @empty
            ...
            <div class="row">
                @foreach ($featuredProducts as $featured_product)
                    <div class="col-lg-4 col-md-6 col-12 d-flex">
                        ...
                        <div class="single-product w-100 d-flex flex-column">

                            <div class="product-image">
                                <img src="{{ asset('storage/' . $featured_product->image) }}" alt="#">

                                @if ($featured_product->discount_percent > 0)
                                    <span class="sale-tag">
                                        -{{ $featured_product->discount_percent }}%
                                    </span>
                                @endif
                            ...
                            <div class="product-info d-flex flex-column flex-grow-1">
                                ...
                                <span class="category">
                                    {{ $featured_product->category->name }}
                                </span>
                                ...
                                <div class="price mt-auto">
                                    <span>BDT {{ $featured_product->selling_price }}</span>
                                    <span class="discount-price">
                                        BDT {{ $featured_product->regular_price }}
                                    </span>
                                </div>
