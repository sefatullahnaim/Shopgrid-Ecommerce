...
<ht lang="en">
    ...
    <head>
        ...
        <title>@yield('title') | ShopGrid-E-commerce Website</title>
    ...
    <body>
                            ...
                            <div class="mega-category-menu">
                                ...
                                <ul class="sub-category">
                                    @foreach ($categories as $category)
                                        <li>
                                            <a href="{{ route('product.categories', $category->id) }}">
                                                {{ $category->name }}
                                            ...
                                            <ul class="inner-sub-category">
                                                @if ($category->subCategories->isNotEmpty())
                                                    @foreach ($category->subCategories as $subCategory)
                                                        <li>
                                                            <a
                                                                href="{{ route('product.subcategories', $subCategory->id) }}">
                                                                {{ $subCategory->name }}
                                                            </a>
                                                        </li>
                                                    @endforeach
                        ...
                        <div class="row">
                            <div class="col-lg-3 col-md-4 col-12">
                                <div class="footer-logo">
                                    <a href="index.html">
                                        <img src="{{ asset('/') }}assets/images/logo/white-logo.svg"
                                            alt="#">
                                    </a>
                                </div>
                            </div>
        ...
        <script>
            const finaleDate = new Date("February 15, 2030 00:00:00").getTime();
