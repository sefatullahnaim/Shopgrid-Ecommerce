...
@section('body')
    ...
    <section class="item-details section">
        <div class="container">
            @if (session('success'))
                <div class=" bg-success-gradient border border-success text-success-600 px-4 py-3 rounded mb-4">
                    {{ session('success') }}
                </div>
            @endif
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6 col-md-12 col-12">
                        <div class="product-images">
                            <main id="gallery">
                                <div class="main-img">
                                    <img src="{{ Storage::url($product->image) }}" id="current" alt="#">
                                </div>
                                <div class="images">
                                    @foreach ($product->productImages->take(5) as $productImage)
                                        <img src="{{ Storage::url($productImage->image) }}" class="img" alt="#" />
                                    @endforeach
                                </div>
                            </main>
                        </div>
                    ...
                    <div class="col-lg-6 col-md-12 col-12">
                        <div class="product-info">
                            ...
                            <p class="category">
                                <i class="lni lni-tag"></i> Product Unit :
                                <a href="javascript:void(0)">{{ $product->unit->name }}</a>
                            </p>
                            <p class="category">
                                <i class="lni lni-tag"></i> Stock :
                                <a href="javascript:void(0)">{{ $product->stock >= 2 ? 'Available' : 'Not Available' }}</a>
                            </p>
                            <h3 class="price">BDT {{ $product->selling_price }}<span> BDT
                                    {{ $product->regular_price }}</span></h3>
